...
namespace SPALM.SPSF.Library.References
{
    ...
    public class SharePointVersionDependendReference : UnboundRecipeReference, IAttributesConfigurable
    {
        ...
        public SharePointVersionDependendReference(string template)
            : base(template)
        {
        }
        ...
        /// </summary>
        protected SharePointVersionDependendReference(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            try
            {
