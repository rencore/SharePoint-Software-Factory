...
{
  [Serializable]
  public class ConfigurationReferenceTemplate : UnboundTemplateReference
  {
    public ConfigurationReferenceTemplate(string template)
      : base(template)
    {
    }
    ...
    /// </summary>
    protected ConfigurationReferenceTemplate(SerializationInfo info, StreamingContext context)
      : base(info, context)
    {
    }
